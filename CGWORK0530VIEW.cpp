...
IMPLEMENT_DYNCREATE(CCGWORK0530View, CView)

BEGIN_MESSAGE_MAP(CCGWORK0530View, CView)
...
CCGWORK0530View::CCGWORK0530View()
{
...
BOOL CCGWORK0530View::PreCreateWindow(CREATESTRUCT& cs)
{
...
void CCGWORK0530View::OnDraw(CDC* pDC)
{
...
BOOL CCGWORK0530View::OnPreparePrinting(CPrintInfo* pInfo)
{
	// default preparation
	return DoPreparePrinting(pInfo);
}

void CCGWORK0530View::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add extra initialization before printing
}

void CCGWORK0530View::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
...
#ifdef _DEBUG
void CCGWORK0530View::AssertValid() const
{
	CView::AssertValid();
}

void CCGWORK0530View::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CCGWORK0530Doc* CCGWORK0530View::GetDocument() // non-debug version is inline
{
...
void CCGWORK0530View::OnMenuitem11() 
{//图形绘制-绘制矩形
...
void CCGWORK0530View::OnMenuitem12() 
{//图形绘制-绘制圆形
	// TODO: Add your command handler code here
	m_DrawType = 2;//2表示圆形
	m_isDraw = true;//初始状态为绘图状态
...
void CCGWORK0530View::OnMenuitem13() 
{//图形绘制-设置颜色
	// TODO: Add your command handler code here
	CSetStyleDlg dlg;
	if (dlg.DoModal() == IDOK)
...
void CCGWORK0530View::OnMenuitem21() 
{//区域填充-绘制多边形
	// TODO: Add your command handler code here
...
void CCGWORK0530View::OnMenuitem22() 
{//区域填充-设置颜色
	// TODO: Add your command handler code here
	CSetStyleDlg2 dlg;
	if (dlg.DoModal() == IDOK)
...
void CCGWORK0530View::OnMenuitem31() 
{//三维变换-绘制立方体
	// TODO: Add your command handler code here
	Invalidate();
	// TODO: Add your command handler code here
...
void CCGWORK0530View::OnMenuitem32() 
{//三维变换-延x轴方向平移
	// TODO: Add your command handler code here
	m_CubeMenuState=1;
}

void CCGWORK0530View::OnMenuitem33() 
{//三维变换-延y轴方向平移
	// TODO: Add your command handler code here
	m_CubeMenuState=2;
}

void CCGWORK0530View::OnMenuitem34() 
{//三维变换-延z轴方向平移
	// TODO: Add your command handler code here
	m_CubeMenuState=3;
}

void CCGWORK0530View::OnMenuitem35() 
{//三维变换-绕x轴旋转
	// TODO: Add your command handler code here
	m_CubeMenuState=4;
}

void CCGWORK0530View::OnMenuitem36() 
{//三维变换-绕y轴旋转
	// TODO: Add your command handler code here
	m_CubeMenuState=5;
}

void CCGWORK0530View::OnMenuitem37() 
{//三维变换-绕z轴旋转
	// TODO: Add your command handler code here
	m_CubeMenuState=6;
}

void CCGWORK0530View::OnMenuitem38() 
{//三维变换-设置数据
	// TODO: Add your command handler code here
	CSetStyleDlg3 dlg;
	if (dlg.DoModal() == IDOK)
...
void CCGWORK0530View::OnMenuitem39() 
{//三维变换-更改表现形式
	// TODO: Add your command handler code here
...
void CCGWORK0530View::OnMenuitem41() 
{//绘制曲线-绘制Bezier曲线
	// TODO: Add your command handler code here
...
void CCGWORK0530View::OnMenuitem51() 
{//清屏
	// TODO: Add your command handler code here
	CCGWORK0530Doc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CCGWORK0530View::OnLButtonDown(UINT nFlags, CPoint point) 
{//鼠标左键按下
...
void CCGWORK0530View::OnMouseMove(UINT nFlags, CPoint point) 
{//鼠标移动
	// TODO: Add your message handler code here and/or call default
...
void CCGWORK0530View::OnLButtonUp(UINT nFlags, CPoint point) 
{//鼠标左键抬起
	// TODO: Add your message handler code here and/or call default
...
void CCGWORK0530View::OnRButtonDown(UINT nFlags, CPoint point) 
{
	// TODO: Add your message handler code here and/or call default
...
void CCGWORK0530View::DrawLButtonDown(UINT nFlags, CPoint point)
{//鼠标绘图时鼠标左键按下处理函数
...
void CCGWORK0530View::DrawMouseMove(UINT nFlags, CPoint point)
{//鼠标绘图时鼠标移动处理函数
	SetCursor(m_Cursor);//设置使用光标资源
...
void CCGWORK0530View::DrawLButtonUp(UINT nFlags, CPoint point)
{//鼠标绘图时鼠标左键抬起处理函数
	SetCursor(m_Cursor);//设置使用光标资源
	ReleaseCapture();//释放鼠标
	CDC* pDC = this->GetDC();//获得设备环境对象
...
void CCGWORK0530View::DrawRButtonDown(UINT nFlags, CPoint point)
{
	if (m_DrawType == 3)
	{
		CDC* pDC = this->GetDC();//获得设备环境对象
...
void CCGWORK0530View::DDALine(CDC *pDC, int x1, int y1, int x2, int y2, COLORREF curColor)
{
	double dx,dy,e,x,y;
	dx=x2-x1;  dy=y2-y1;
...
void CCGWORK0530View::MidPointCircle(CDC *pDC, CPoint p1, CPoint p2, COLORREF color)
{
...
void CCGWORK0530View::DrawCube(CDC *pDC, int type)
{
...
double** CCGWORK0530View::doTranslate(double **target)
{
	for(int i=0;i<8;i++){
		for(int j=0;j<3;j++)
...
double** CCGWORK0530View::doRotate(double **target)
{
	double Trigono[3][2];
	double tmp[3];
	double arc;
...
void CCGWORK0530View::FillFace(CPoint *P, CDC *pDC, COLORREF curFill, int type)
{
	int xl,xr,yt,yd;
	bool flag;
	int i,j,k;
...
void CCGWORK0530View::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
	// TODO: Add your message handler code here and/or call default
	if(m_DrawType==31){
		if(!m_CubeMenuState){
...
void CCGWORK0530View::ChangeCubeType()
{
	m_CubeType=!m_CubeType;
	Invalidate();
}
...
void CCGWORK0530View::DrawPoint(CDC *pDC, CPoint p, int siz)
{
	int x=p.x-siz;
	int y=p.y-siz;
	int i,j;
